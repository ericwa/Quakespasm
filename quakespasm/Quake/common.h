...
void MSG_WriteCoord (sizebuf_t *sb, float f, unsigned int protocol, unsigned int flags);
void MSG_WriteAngle (sizebuf_t *sb, float f, unsigned int protocol, unsigned int flags);
void MSG_WriteAngle16 (sizebuf_t *sb, float f, unsigned int protocol, unsigned int flags); //johnfitz
...
float MSG_ReadCoord (unsigned int protocol, unsigned int flags);
float MSG_ReadAngle (unsigned int protocol, unsigned int flags);
float MSG_ReadAngle16 (unsigned int protocol, unsigned int flags); //johnfitz
